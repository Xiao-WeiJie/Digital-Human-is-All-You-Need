...
from ttsreal import EdgeTTS,SovitsTTS,XTTS,CosyVoiceTTS,FishTTS,TencentTTS,DoubaoTTS,IndexTTS2,AzureTTS,KokoroTTS
...
class BaseReal:
    def __init__(self, opt):
        ...
        # 当前数字人ID（用于获取TTS参考音频）
        self.avatar_id = getattr(opt, 'avatar_id', 'human_1')

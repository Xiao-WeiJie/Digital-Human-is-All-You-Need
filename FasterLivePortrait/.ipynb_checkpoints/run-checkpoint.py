...
def run_with_pkl(args):
    ...
    c_eyes_lst = dri_motion_infos.get("c_eyes_lst", dri_motion_infos.get("c_d_eyes_lst", []))
    c_lip_lst = dri_motion_infos.get("c_lip_lst", dri_motion_infos.get("c_d_lip_lst", []))

    if len(c_eyes_lst) < frame_num:
        c_eyes_lst = list(c_eyes_lst) + [0.0] * (frame_num - len(c_eyes_lst))
    if len(c_lip_lst) < frame_num:
        c_lip_lst = list(c_lip_lst) + [0.0] * (frame_num - len(c_lip_lst))
